...
protocol CurrencyConverterBussinessLogic {
...
class CurrencyConverterInteractor: CurrencyConverterBussinessLogic{
    var worker: Worker?
    var presenter: CurrencyConverterPresenterLogic?
    init(){
        worker = Worker()
    }
